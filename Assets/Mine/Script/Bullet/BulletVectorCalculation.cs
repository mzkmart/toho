...
/// 射撃パターンデータ
/// </summary>
public static class BulletVectorCalculation
{
    ...
    public static Vector2 BulletVector(Vector2 bulletTransform, EnemyShotData shotDate, int bulletNumber, int shotUpdateCount)
    {
        Vector2 moveDirection = default;
        float playerRad = default;
        float angleShift = default;
